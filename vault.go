...
func main() {
	...
	appShowWriteFiles := appShow.Flag("write", "write file attributes on the filesystem").Short('w').Bool()
	...
	case appShow.FullCommand():
		showSecret(*appShowPath, *appShowPrint, *appShowClipboard, *appShowClipAttr, *appShowWriteFiles)
